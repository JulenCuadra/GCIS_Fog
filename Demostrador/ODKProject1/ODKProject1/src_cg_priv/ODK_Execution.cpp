...
{
  FCT_HASH_Publish = 0x2BBA6648,
  FCT_HASH_CheckSubscriptions = 0x8526597D,
  FCT_HASH_ReadFabPlan = 0x11DAC2CB,
                              ...
                              , const char*       out)
{
  switch (cmd)
  {
    case FCT_HASH_Publish:
    {
      return Publish ((ODK_S7STRING*) &(in[0]));
    }
    case FCT_HASH_CheckSubscriptions:
    {
      *((ODK_S7STRING*) &(out[0] )) = 254;
      *((ODK_S7STRING*) &(out[257] )) = 254;
      return CheckSubscriptions ((ODK_S7STRING*) &(out[0]), *((ODK_INT8*) &(out[256])), (ODK_S7STRING*) &(out[257]), *((ODK_INT8*) &(out[513])), *((ODK_BOOL*) &(inout[0])));
    }
    case FCT_HASH_ReadFabPlan:
    {
      return ReadFabPlan (*((control_flags*) &(out[0])), *((fog2plc*) &(out[3])));
    }
