...
def check_event_action_relationships(source,event):
    ...
    resource = client_customresources.get_namespaced_custom_object('ehu.gcis.org','v1alpha1','default','components','dummy-component')#todo obtener la parte final del source para nombre de componente
